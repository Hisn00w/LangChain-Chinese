...
LangChain 是开始构建由大语言模型（LLM）驱动的智能体（Agent）和应用程序的**最简单方式**。只需不到 10 行代码，你就可以连接到 OpenAI、Anthropic、Google，以及[更多提供商](https://docs.langchain.com/oss/python/integrations/providers/overview)。  
...
[LangGraph](https://docs.langchain.com/langgraph/overview)

LangChain 的 [Agents](core-components/agents.md) 构建在 LangGraph 之上，以提供：
